...
A third, very hot, $>40\,$MK component could only be poorly constrained due to a lack of sensitivity to flux above $5\,$keV. DS Tuc A, a young G dwarf, has been observed flaring with a >50 MK temperature in the flare peaks~\citep{pillitteri2022xraya}, and PMS stars can exceed 100 MK~\citep{getman2008xray, getman2021xray}. The Sun can heat the corona up to over 30 MK during flares~\citep{benz2016flare}. A flare on AD Leo had a peak temperature of about 37 MK~\citep{stelzer2022great}. Other M dwarf flares are well-described with two temperatures~\citep{robrade2010quiescent, behr2023muscles, magaudda2022firsta}. The corona of NLTT 33370 AB, an M7 binary with a rotation period of about $3.8\,$h (close to TIC 277's $4.56\,$h) is combined of a 3.1 MK and 14 MK component~\citep{williams2015simultaneous}. However, flares on Proxima Cen (M5.5, 85 d rotation~XXXX), also appear with temperatures of 2-3 MK and 10-20 MK~\citep{gudel2004flares,fuhrmeister2022high, howard2022mouse}.
