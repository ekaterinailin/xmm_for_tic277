...
\centering
    ...
    \caption{Flares detected with TESS. $a$ is the relative amplitude, and $E$ is the bolometric flare energy assuming a 10,000 K blackbody emission from the flare.
