...
if __name__ == "__main__":
    ...
    sel["ed_rec"] = sel["ed_rec"] / 1e30
    sel["ed_rec_err"] = sel["ed_rec_err"] / 1e30

    # format
    sel[r"$E_{\rm bol}$ [$10^{30}$ erg]"] = (sel["ed_rec"].round(2).astype(str) + 
                                            " [" + 
    ...
    sel = sel[[r"$t_{s}$ [BJD - 2457000]", r"$a$", r"$E_{\rm bol}$ [$10^{30}$ erg]", "Sector"]]
