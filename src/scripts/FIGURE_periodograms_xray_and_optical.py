...
if __name__ == "__main__":
    ...
    df = pd.read_csv(paths.data / "stacked_xray_lightcurve.csv")
    ...
    plt.savefig(paths.figures  / "periodogram_xmm_stacked.png", dpi=300)
    ...
    plt.savefig(paths.figures  / "periodogram_om.png", dpi=300)